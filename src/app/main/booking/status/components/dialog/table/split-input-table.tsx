import { type CSSProperties, type Dispatch, useCallback, useMemo } from "react";
									...
									{props.row.original.containers.map((container, index) => {
										return (
											<GridSelectionComponent
												key={`${container.typeSize}_${index}` || ""}
										...
										return (
											<GridSelectionComponent
												...
												onSelectionChange={(value) => {
													...
													newContainers[index] = {
														...container,
														slot: Number.parseFloat(value) || 0,
														quantity: undefined,
													};
									...
									{props.row.original.containers.map((container, index) => {
										return (
											<div
												...
												key={
													`${container.typeSize}_${container.slot}_${index}` ||
													""
												}
											>
												<MdOutlinedTextField
